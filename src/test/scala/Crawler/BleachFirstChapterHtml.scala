...
object BleachFirstChapterHtml {
  val firstChapterHtml: String =
      """
  <html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en" xml:lang="en">
    ...
    <div id="topchapter">
      ...
      <div id="navi">
        ...
        <div id="selectpage"><select id="pageMenu" name="pageMenu">
          <option value="/bleach/1" selected="selected">1</option>
